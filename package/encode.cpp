...
MPP_RET MppEncoder::test_mpp_enc_cfg_setup(MpiEncData *p) {
	...
	mpp_enc_cfg_set_s32(cfg, "rc:change", MPP_ENC_RC_CFG_CHANGE_ALL);
...
void MppEncoder::setUp(int width, int height, int fps, int input_type, int output_type) {
	...
	switch (output_type) {
		case 1:
			...
			break;
		case 2:
			args_.type = MPP_VIDEO_CodingMJPEG;
			break;
	}
