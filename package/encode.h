...
class MppEncoder {
 public:
	...
	void setUp(int width, int height,int fps, int input_type, int output_type);
    void MppEncdoerInit(int width, int height, int fps, int input_type, int output_type){setUp(width, height, fps, input_type, output_type); }
    void destory() {deinit();};
